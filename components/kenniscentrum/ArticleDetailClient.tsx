      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        {article.slug && (
          <div className="mt-10 flex items-center gap-3 flex-wrap">
            ...
            <a
              href={`https://www.linkedin.com/sharing/share-offsite/?url=https%3A%2F%2Faigeletterdheid.academy%2Fkenniscentrum%2F${article.slug}`}
              target="_blank"
            ...
            <a
              href={`https://x.com/intent/tweet?url=https%3A%2F%2Faigeletterdheid.academy%2Fkenniscentrum%2F${article.slug}&text=${encodeURIComponent(article.title)}`}
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 px-4 py-2 rounded-lg border border-border text-sm text-foreground hover:border-primary/40 hover:text-primary transition-colors"
            >
